                            ...
                            <div class="tab-content" id="profile-content">
                                    ...
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group">
                                            <label for="shop_about">
                                                Информация о магазине <span class="text-danger req-star">*</span>
                                            </label>
                                    ...
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group" ng-repeat="item in address">
                                            ...
                                            <label for="" ng-show="$index == 0">
                                                Улица, дом, офис <span class="text-danger req-star">*</span>
                                            </label>
                                ...
                                <div class="tab-pane" id="m_contacts" role="tabpanel">
                                    ...
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group">
                                            <label for="shop_name">
                                                Телефон <span class="text-danger req-star">*</span>
                                            </label>
                                        ...
                                        <div class="form-group m-form__group">
                                            <label for="shop_name">
                                                Email <span class="text-danger req-star">*</span>
                                            </label>
                                            <div class="m-input-icon m-input-icon--left input-group-sm">
                                ...
                                <div class="tab-pane" id="shop_users" role="tabpanel">
                                    ...
                                    <div class="m-portlet__body">
                                        ...
                                        <h3 class="m-portlet__head-text">Руководители <span class="text-danger req-star">*</span></h3>
                                        ...
                                        <h3 class="m-portlet__head-text">Флористы-менеджеры <span class="text-danger req-star">*</span></h3>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group m-form__group datepair">
                                                            <label for="">
                                                                Время доставки, Часов:минут <span class="text-danger req-star">*</span>
                                                            </label>
                                            ...
                                            <div class="col-md-12" style="padding-top: 20px">
                                                ...
                                                <div class="row" id="delivery_out_city_container" style="{{ !$shop->delivery_out ? 'display: none;' : null }}">
                                                    <div class="col-md-6">
                                                        <div class="form-group m-form__group">
                                                            <label for="">
                                                                Максимально возможная удаленность, км <span class="text-danger req-star">*</span>
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group m-form__group">
                                                            <label for="">
                                                                Стоимость доставки, руб/1 км <span class="text-danger req-star">*</span>
                                                            </label>
