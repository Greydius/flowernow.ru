                        ...
                        <form>
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <div class="row" id="product-photos">
                                    ...
                                    <div class="col-md-2 product-photos-container" style="width: 80px; height: 80px" ng-repeat="photo in photos">
...
@section('footer')
    ...
    <script src="{{ asset('assets/admin/js/products-list.js?v=1') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/admin/ng/productsList.js?v=1') }}" type="text/javascript"></script>
