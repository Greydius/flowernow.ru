                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="padding: 0px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                    <p>У многих магазинов остались не не принятые заказы с 8 марта.</p>

                                    <p>Большинство клиентов сообщают, что готовы перенести не принятые Вами заказы на 9-10 марта.</p>

                                    <p>Просим связаться с клиентами и договориться о переносе заказов!</p>
