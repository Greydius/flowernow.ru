                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="padding: 0px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                    <p>Пожалуйста, не забывайте своевременно изменять статусы заказов на актуальные. </p>

                                    <p>Проверьте ещё раз личные кабинеты.</p>
                                    <br/>
                                    <p>Огромная просьба, если вы понимаете, что не сможете обработать часть заказов от <a href="https://www.floristum.ru/">Floristum.ru</a>, сообщить нам любым удобным способом- мы передадим их.</p>
