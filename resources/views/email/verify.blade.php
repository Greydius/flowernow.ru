                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="padding: 0px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                    <p>Спасибо за создание аккаунта. Пожалуйста, перейдите по ссылке ниже, чтобы подтвердить свой адрес электронной почты</p>

                                    <p>{{ route('register.verify', ['code' => $confirmation_code]) }}</p>
