...
@section('content')
    ...
    <div class="container">
        <br>
        <h1 class="h2 margin-top-null m-b-1"><strong>Доставка букетов цветов</strong> - всегда бесплатная по городу</h1>
        ...
        <div class="row m-b-3">
            <div class="col-md-10">
                <p> <img src="{{ asset('assets/front/img/dostavka_tsvetov.png') }}" height="100px" Align="left" hspace="25">Доставка в рамках одного города осуществляется бесплатно. В Москве доставка также бесплатная, если она не выходит за пределы МКАД. Если букет нужно доставить за пределы города, стоимость услуги устанавливается цветочным магазином или непосредственно флористом. Зависеть она будет от расстояния.</p>
