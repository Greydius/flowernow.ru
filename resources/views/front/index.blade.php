...
@section('content')
    ...
    <div class="container">
        ...
        <p>Флористум – это федеральная сеть доставки цветов в {{ $current_city->name_prepositional }} и по всей России. <br><br>
    Юбилей, день рождения, корпоративное мероприятие, семейное торжество, день святого Валентина, 23 февраля, 8 марта - на нашем сайте вы сможете заказать букеты на праздникс доставкой в офис, на дом или по другому, указанному адресу. 
    </br> </br>  
Живые цветы идеальны для того, чтобы подчеркнуть значимость момента, создать нужное настроение и… оказать мягкое психологическое воздействие на вашего визави. Не верите? К примеру, первое свидание. Вот как вы думаете, к какому парню у девушки сразу возникнет интерес – к тому, который пришел без цветов, или к тому, который не забыл купить букет для любимой.
</br></br>
В {{ $current_city->name_prepositional }} работает много компаний предоставляющих такую услугу,
как доставка букетов в {{ $current_city->name_prepositional }}. В чем же преимущество сети
Floristum?</br></br>
Букеты, по соотношению цена/свежесть, одна из самых оптимальных в регионе. Вы всегда можете сравнить стоимость наших услуг с предложениями конкурентов.тов.</br></br>
<h3>Доставка цветов {{ $current_city->name }}</h3>
Доставка букетов цветов {{ $current_city->name_prepositional }} с Floristum.ru – это всегда быстро, свежо, креативно и недорого. Работаем круглосуточно – для нас нет праздничных и выходных дней. Опрятный и вежливый курьер доставит и вручит букет цветов, озвучит поздравление, а также сфотографирует получателя в этот трогательный момент. Оформить у нас флористическую композицию с доставкой домой или в офис – это гарантированный сюрприз для вашего адресата.
</br></br>
В Флористум цветочные композиции создают профессионалы высочайшего класса. Каждый собранный букет можно смело называть оригинальным.

Заказчик имеет возможность оставить отзыв на сайте и выставить рейтинг флористу. Эти оценки позволяют нам корректировать работу добиваясь постоянного повышения качества оказываемых услуг. Чтобы поднять близкому человеку настроение, достаточно преподнести живые цветы, оформленные в виде оригинального букета или корзины.

</br></br>
Мы предлагаем оценить подарочную тему шире, чем просто «сопровождающий элемент» ухаживания или «гарнир» подарка на день рождения. Современные флористические композиции активно используются для украшения интерьера. Живыми цветами можно оформить банкетный зал, офис, сопроводить свадебную церемонию, украсить яхту или автомобиль, создать фруктово-конфетно-цветочные корзины на детском празднике и т.д.</br></br>
