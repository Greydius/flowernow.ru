...
<li>
                        ...
                        <p>Заказывайте доставку из любого города в любой город России! Всё что нужно — указать город, выбрать подходящий букет цветов и указать параметры для доставки.</p>
                    </li>
                    <li>
        ...
        <br><br><br><strong>У Нас нет наценок при оплате с расчетного счета.</strong><h3 class="margin-top-null"><strong>Цены на цветы такие же, как для физ. лиц:</strong></h3></br></br>
